...
На данном слое отображаются данные с сервиса Wikimapia. Этот слой может служить источником информации об объектах, не отмеченных на других картах.
...
- направление движение облаков (градусы в секунду) и их высота;
...
На этом слое можно посмотреть треки поисков, полученные из разных источников. При выборе этого слоя возможно показывать на карте только часть треков (переключатель "все/ЛизаАлерт/Отклик/Экстремум/прочие" появится в меню карт и слоев, если данный слой активен).
...
### Фото местности
![Фото местности](/assets/images/ui-maps-and-layers/photos.png)

Горячая клавиша: **P**

На этом слое можно посмотреть фотографии, полученные через бота Telegram. [Подробнее о добавлении фотографий и треков](https://help.gis.extremum.org/telegram-bot.html)
