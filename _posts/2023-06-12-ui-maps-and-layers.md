...
**Синие** — все предыдущие координаты с устройства. Для надёжности определения координат и скорости используются методы разной точности. За один сеанс определения координат, чем позже данные тем, как правило, они более точные.
...
Пожалуйста, используйте сервисы геолокации только по назначению. «Экспериментировать» с ними не стоит, даже если вы убеждены что вам очень надо и ничего не будет если пару раз вы туда сходите. Простота входа в них необходима для того, чтобы пострадавшие могли легко туда попасть по ссылке отправленной спасателями. Помните, что если будете использовать в тренировочных целях в сезон (с мая по октябрь включительно) у вас есть существенный риск, что вас заблокируют всем провайдером или регионом в самый неожиданный момент.
