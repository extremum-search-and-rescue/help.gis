...
На небе находится Солнце. Закрыто плотными облаками. Сильный ветер, уже позволяет ориентировать некоторых потерявшихся по направлению ветра, особенно в моменты порывов, +16 градусов по Цельсию, сильный дождь. На слое «Ветер, дождевые облака» можно будет видеть форму туч и оценить моменты усиления или ослабления дождя.
...
Слой с данными от трекеров предназначен для использования на поисково-спасательных работах и позволяет отслеживать местоположение групп и направление их движения. [Подробнее о трекерах](https://help.gis.extremum.org/online-tracking.html) и способах их настройки. Данные отображаются 24 часа. На карте трекер может выглядеть как флажок или как стрелочка направления. Стрелочка отображается, если от трекера совсем недавно приходили свежие данные о местоположении, и известно направление движения от самого трекера.

В примере на картинке показан завершенный маршрут. В подписи к пиктограмме группы указывается имя пользователя, а также дата и время предыдущего получения информации от трекера.
