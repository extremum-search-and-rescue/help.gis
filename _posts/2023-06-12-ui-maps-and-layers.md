...
- Средняя часть не имеет отношения к OSM и содержит информацию о затоплениях по данным космических аппаратов, данные о рельефе (из источников ArcticDEM / Copernicus DEM / FABDEM), высоте деревьев на карте «День» и световой засветке на карте «Ночь»;
