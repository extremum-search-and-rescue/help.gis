...
> ##### Как часто обновляется информация от GPS-трекеров на карте?
> В среднем - раз в 7-10 секунд. Обычно максимальное время обновления составляет не более 30 секунд.
...
4. Далее вам потребуется открыть приложение (программе необходимо дать все необходимые доступы при запросе), открыть настройки и заполнить все поля:
- В поле **URL сервера** вставить полученную от бота ссылку;
- **Location Accuracy/Точность определения местоположения** выбрать **highest/наивысшая**;
- **Distance/Дистанция** выбрать **5**;
- **Interval/Интервал** выбрать **15** (**5** для автомобиля; частота отправки/обновления данных на карте и сервере в секундах: чем меньше значение, тем быстрее будет разряжаться устройство);
- **Stationary heartbeat/Интервал неподвижности** выбрать **60**;
- Включить **Advanced Settings/Расширенные настройки**;
- Включить **Stop detection/Обнаружение остановки**;
- Включить **Offline buffering/Буферизация оффлайн**.
